...
#define MSGBUFFER_MAXLEN 1024

/* static global variable declaration */
static int          g_ipset_socket = -1;
static size_t       g_ipset_nlmsg_seq = 0;
...
static ipv4_addr_t *g_ipset_ipv4addr_memory_pointer = NULL;
static ipv6_addr_t *g_ipset_ipv6addr_memory_pointer = NULL;
...
static void ipset_prebuild_nlmsg(bool is_ipv4) {
    ...
    *(uint8_t *)((void *)ipset_protocol_attr + NLMSG_ALIGN(sizeof(struct nlattr))) = IPSET_PROTOCOL;
    ...
    g_ipset_ipv4addr_memory_pointer = (void *)&ipset_ip_attr->nla_type + sizeof(ipset_ip_attr->nla_type);
    g_ipset_ipv6addr_memory_pointer = (void *)&ipset_ip_attr->nla_type + sizeof(ipset_ip_attr->nla_type);
